...
BEGIN_MESSAGE_MAP(CGeometryApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CGeometryApp::OnAppAbout)
...
CGeometryApp::CGeometryApp()
{
	...
	SetAppID(_T("Geometry.AppID.NoVersion"));
...
void CGeometryApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CGeometryApp customization load/save methods

void CGeometryApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CGeometryApp::LoadCustomState()
{
}

void CGeometryApp::SaveCustomState()
{
}
